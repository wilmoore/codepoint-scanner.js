# Contributing to codepoint-scanner

Below are a few ways to make contributing to `codepoint-scanner` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/codepoint-scanner.js.git
    cd codepoint-scanner.js
    npm install
    npm run dev
